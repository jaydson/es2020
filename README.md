...
## Dynamic imports  
Vídeo (portuguese only for now): https://www.youtube.com/watch?v=zjN7pbK7aKQ  
...
## Optional chaining  
Vídeo (portuguese only for now): https://youtu.be/0xDSWkxrnpg  
...
## Nullish coalescing  
Vídeo (portuguese only for now): https://youtu.be/PdZ10n19Juo  
...
## globalThis  
Vídeo (portuguese only for now): https://youtu.be/qBf8AyxJTXY  
...
Vídeo (portuguese only for now): https://youtu.be/ybnutq-qEIs  
...
## Promise allSettled  
Vídeo (portuguese only for now): https://youtu.be/sHOZYxBXS_0  
